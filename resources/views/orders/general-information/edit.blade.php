<x-app>
    <x-content-header>
        <h1 class="m-0">{{ __('Edit General Information') }}</h1>
    </x-content-header>
    ...
    <section class="content">
        <div class="row">
            <div class="col-lg-4">
                <form
                    action="{{ route('orders.general-information.update', $order) }}"
                    method="POST"
                    novalidate
                >
                    @csrf
                        ...
                        <div id="source-module" class="card-body">
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    name="source_id"
                                    id="source_id"
                                    value="{{ old('source_id') ?? $order->source_id }}"
                                />
                                <input
                                    type="text"
                                    id="source_name"
                                    ...
                                    value="{{ old('source_name') ?? $order->source_name }}"
                                />
                                @error('source_name')
                        ...
                        <div id="customer-module" class="card-body">
                            ...
                            <div id="province-module" class="form-group">
                                ...
                                <input
                                    ...
                                    value="{{ old('customer_province') ?? $order->customer_province }}"
                                />
                            ...
                            <div id ="city-module" class="form-group">
                                ...
                                <input
                                    ...
                                    @if(!old('customer_city') && !$order->customer_city) disabled @endif
                                />
                                @error('customer_city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div id="subdistrict-module" class="form-group">
                                ...
                                <input
                                    ...
                                    value="{{ old('customer_subdistrict') ?? $order->customer_subdistrict }}"
                                    @if(!old('customer_subdistrict') && !$order->customer_subdistrict) disabled @endif
                                />
                            ...
                            <div id="village-module" class="form-group">
                                ...
                                <input
                                    ...
                                    value="{{ old('customer_village') ?? $order->customer_village }}"
                                    @if(!old('customer_village') && !$order->customer_village) disabled @endif
                                />
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    ...
                                    value="{{ old('customer_postal_code') ?? $order->customer_postal_code }}"
                                />
